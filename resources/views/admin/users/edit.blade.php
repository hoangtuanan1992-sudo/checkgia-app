                    ...
                    <div class="card" style="max-width:none;border-radius:14px;box-shadow:none;margin-top:14px" id="updateIntervalCard">
                        ...
                        <div class="card-body" style="padding:8px 16px 16px">
                            <div class="field" style="margin-top:0;max-width:360px">
                                ...
                                <input class="input" id="scrape_schedule_times" name="scrape_schedule_times" type="text" value="{{ old('scrape_schedule_times', $userScrapeSetting->scrape_schedule_times ?? '5 10 20') }}" placeholder="VD: 5 10 20">
